...
#get-installedsoftware | Export-Csv -Path "c:\Disks\$env:computername.csv" -NoTypeInformation
get-installedsoftware | Export-Csv -Path \\asm-wh-app1\sysinfo\$env:computername.csv -NoTypeInformation